...
import NewApiController from '../newApiPortal.controller';
...
class ApiCreationController {
  ...
  constructor(private $scope,
    ...
    'ngInject';
    this.api = {};
    this.api.gravitee = Constants.definitionVersions.includes($stateParams.definitionVersion) ? $stateParams.definitionVersion : Constants.definitionVersions[0];
